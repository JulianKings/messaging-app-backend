...
function _default(passport) {
  return _defineProperty(_defineProperty(_defineProperty({
    ...
    get_communities: (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
        var myCommunities, responseObject;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _groupMembers["default"].find({
                user: req.user._id
              }).populate("group").exec();
            case 2:
              myCommunities = _context2.sent;
              responseObject = {
  ...
  }())), "get_friends", (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
      var myFriends, responseObject;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _userRelationships["default"].find({
              user: req.user._id,
              relationship: 'friend'
            }).populate("friend").exec();
          case 2:
            myFriends = _context4.sent;
            responseObject = {
              responseStatus: 'validRequest',
              friends: myFriends
            };
