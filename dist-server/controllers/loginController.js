...
function _default(passport) {
  return {
    ...
    (0, _expressValidator.body)("username", "User name must not be empty.").trim().isLength({
      min: 1
    }).escape(), (0, _expressValidator.body)("password", "Password must not be empty.").trim().isLength({
      min: 1
    }).escape(), (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
        var errors, responseObject;
