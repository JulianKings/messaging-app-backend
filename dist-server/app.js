...
var _sso = _interopRequireDefault(require("./routes/sso"));
var _community = _interopRequireDefault(require("./routes/community"));
...
var loginRouterHandler = (0, _login["default"])(_passport["default"]);
var ssoRouterHandler = (0, _sso["default"])(_passport["default"]);
app.use('/sign-up', _signup["default"]);
app.use('/login', loginRouterHandler);
app.use('/sso', _passport["default"].authenticate('jwt', {
  session: false
}), ssoRouterHandler);
app.use('/community', _community["default"]);
var nameField = 'username';
var pwdField = 'password';
_passport["default"].use('login', new LocalStrategy({
  usernameField: nameField,
  passwordField: pwdField
}, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, password, done) {
    var user, match;
...
_passport["default"].use(new LocalJWTStrategy({
